...
License
-------
**TwoDatabase** is released under the Creative Commons Attribution-NonCommercial-ShareAlike 3.0.
...
Alternatively, On windows you can run the batch file MaNGOSdb_Installer located in the _tools folder
